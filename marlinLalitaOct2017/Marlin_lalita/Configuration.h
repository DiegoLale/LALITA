...
#define STRING_CONFIG_H_AUTHOR "(DiegoLale, poseso)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LALITA"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Lalita
  #define  DEFAULT_Kp 58.43
  #define  DEFAULT_Ki 7.92
  #define  DEFAULT_Kd 107.70
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1143, 200 }
