...
// LCD selection
  ...
  //U8GLIB_SH1106_128X64_2X u8g(U8G_I2C_OPT_NONE | U8G_I2C_OPT_FAST); // 4 stripes ESTE ES EL QUE TRAE POR DEFECTO
  U8GLIB_SSD1306_128X64_2X u8g(U8G_I2C_OPT_NONE | U8G_I2C_OPT_FAST); // 4 stripes COPIADO DEL ANTERIOR PARA QUE LA PANTALLA VAYA BIEN
